...
![cleveland](pix/cleveland.jpg)

* visual perception of quantitative information: [Cleveland hierarchy](http://processtrends.com/toc_data_visualization.htm)

![cleveland](pix/data_vis_1.gif)
...
* the gods: Cleveland (hierarchy), Tufte ("chartjunk", minimizing non-data-ink, sparklines)
* the demi-gods: Wilkinson (Grammar of Graphics), Wickham (ggplot *et al*), [Stephen Few](http://www.perceptualedge.com/), Kaiser Fung [Junk Charts](http://junkcharts.typepad.com/junk_charts/)
* dionysians (infoviz) vs. apollonians (statistical graphics) (Gelman)
