...
Diggle (point patterns); Cressie (everything); Diggle and Ribeiro (geostatistics); Dormann et al (GLMMs for species presence/abundance), Haining
...
* `nlme`: `g[n]ls` and `[n]lme` can handle standard spatial autocorrelation structures
