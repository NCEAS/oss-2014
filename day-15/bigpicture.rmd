...
text(mvec[1],0.5-eps,pos=3,srt=90,"What data?")
text(mvec[3],0.5+eps,pos=3,srt=270,"What assumptions?")
...
* be **VERY, VERY** careful whenever you're using data to decide on a model, especially if doing hypothesis testing (*data snooping*)
